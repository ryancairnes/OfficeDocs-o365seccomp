...
|**Communication**|Manage all communications to custodians identified within cases.  Create hold notices, preset reminders, preset escalations to management, track user acknowledgement, and manage access to a custodian portal where custodians can manage communications for cases where they were named a custodian.|eDiscovery Manager|
...
|**Custodian**|Identify custodians and leverage information from AAD and other sources to easily find associated data sources.  Map mailboxes, OneDrive sites, SharePoint sites, and Teams sites that are associated with custodians.  Once data sources are identified, place a legal hold on content to manage the preservation of the data in the context of a case.|eDiscovery Manager|
