...
|**Global Reader**|Members have read-only access to reports, alerts, and can see all the configuration and settings.<br/><br/> The primary difference between Global Reader and Security Reader is that an Global Reader can access **configuration and settings**.|View-Only Retention Management <br/><br/> View-Only Manage Alerts <br/><br/> View-Only Device Management <br/><br/> View-Only IB Compliance Management <br/><br/> View-Only DLP Compliance Management <br/><br/> Security Reader <br/><br/> Service Assurance View <br/><br/> View-Only Audit Logs <br/><br/> View-Only Record Management <br/><br/> View-Only Recipients|
