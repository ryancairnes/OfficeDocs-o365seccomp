...
|[Part 3: Define information barrier policies](#part-3-define-information-barrier-policies)     |- Define the policies<br/>- View (and if needed, edit) the policies<br/><br/>(Policies are neither active nor applied yet)         |
