...
> [!IMPORTANT]
> This article describes how to plan, define, implement, and manage information barrier policies. Several steps are involved, and the work flow is divided into several parts. Make sure to read through the entire process before you begin defining (or editing) information barrier policies.
