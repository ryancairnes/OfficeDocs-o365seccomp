...
These errors (with error codes of CS008-009, CS012-002, CS001-002, CS003-002 and other failures of the form CS0XX-0XX) indicate that Content Search failed to search specific content locations; in this example, two mailboxes weren't searched. These errors are displayed on the status details flyout page of the Content Search.
