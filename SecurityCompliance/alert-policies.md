...
|**Phish delivered due to tenant or user override** <br/> |Generates an alert when a message detected by O365 as phish is delivered to users due to some allow override. This policy has a **High** severity setting.  <br/> |Threat management<br/> |E5/G5 or Office 365 ATP P1 or P2 add-on subscription  <br/> |
...
|**User impersonation phish delivered to inbox/folder** <br/> |Generates an alert when a message detected as user impersonation is delivered to users due to some allow override. This policy has a **Medium** severity setting.  <br/> |Threat management<br/> |E5/G5 or Office 365 ATP P1 or P2 add-on subscription  <br/> |
