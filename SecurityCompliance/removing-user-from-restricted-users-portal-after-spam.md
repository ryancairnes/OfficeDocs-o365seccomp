...
> [!IMPORTANT]
> In order for alerts to work, audit log search needs to be turned on. More information can be found in [Turn Office 365 audit log search on or off](turn-audit-log-search-on-or-off.md)
