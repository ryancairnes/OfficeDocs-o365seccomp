...
| FamilyDuplicateSet |  | Family_duplicate_set |  | Numeric identifier for families that are exact duplicates of each other (i.e. same content and all same attachments) |
...
| Has attorney | HasAttorney |  | Has attorney | True when at least one of the participants is found in the attorney list; false otherwise |
