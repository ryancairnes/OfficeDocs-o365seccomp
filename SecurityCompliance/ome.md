...
|[Office 365 Advanced Message Encryption](ome-advanced-message-encryption.md) <br/> |An Office 365 or Exchange Online Protection administrator who wants to start using Office 365 Advanced Message Encryption.  <br/> |
|[Office 365 Advanced Message Encryption - email revocation](revoke-ome-encrypted-mail.md) <br/> |An Office 365 or Exchange Online Protection administrator who wants to revoke an email that was encrypted using Office 365 Advanced Message Encryption.  <br/> |
|[Office 365 Message Encryption - email expiration](ome-advanced-expiration.md) <br/> |An Office 365 or Exchange Online Protection administrator who wants to set an expiration date for emails to external recipients who receive mail through the web portal. This applies only to mail that was encrypted using Office 365 Advanced Message Encryption.  <br/> |
